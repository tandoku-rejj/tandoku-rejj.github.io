...
async function run(): Promise<void> {
    ...
    fs.writeFileSync(path.join(outputDir, "word08.txt"), humanReadable);

    console.log("✅ Done. Files saved: word08.json and word08.txt");
}
