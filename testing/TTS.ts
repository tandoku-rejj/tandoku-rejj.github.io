...
async function run(): Promise<void> {
    ...
    fs.writeFileSync(path.join(outputDir, "word02.txt"), humanReadable);

    console.log("✅ Done. Files saved: word02.json and word02.txt");
}
