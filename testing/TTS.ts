...
async function run(): Promise<void> {
    ...
    fs.writeFileSync(path.join(outputDir, "word05.txt"), humanReadable);

    console.log("✅ Done. Files saved: word05.json and word05.txt");
}
