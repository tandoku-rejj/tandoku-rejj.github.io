...
async function run(): Promise<void> {
    ...
    fs.writeFileSync(path.join(outputDir, "word04.txt"), humanReadable);

    console.log("✅ Done. Files saved: word04.json and word04.txt");
}
