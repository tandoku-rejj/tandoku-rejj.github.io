...
async function run(): Promise<void> {
    ...
    fs.writeFileSync(path.join(outputDir, "word03.txt"), humanReadable);

    console.log("✅ Done. Files saved: word03.json and word03.txt");
}
